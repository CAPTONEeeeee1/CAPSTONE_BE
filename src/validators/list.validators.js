...
// Schema để cập nhật List (đổi tên, thay đổi thứ tự, đánh dấu hoàn thành)
...
const deleteListSchema = z.object({
    listId: z.string().cuid({ message: 'Định dạng ID list không hợp lệ' }),
    // Tùy chọn: ID của List đích để di chuyển các Card hiện có sang
    moveToListId: z.string().cuid({ message: 'Định dạng ID list đích không hợp lệ' }).optional()
});

// Schema để sắp xếp lại nhiều List
